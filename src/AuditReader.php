...
class AuditReader
{
     ...
     */
    public function findEntitesChangedAtRevision(int|string $revision)
    {
     ...
     * @return ChangedEntity<object>[]
     */
    public function findEntitiesChangedAtRevision(int|string $revision)
    {
     ...
     * @return Revision
     */
    public function findRevision(int|string $revision)
    {
