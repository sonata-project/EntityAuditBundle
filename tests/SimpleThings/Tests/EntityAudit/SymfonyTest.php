...
class SymfonyTest extends \PHPUnit_Framework_TestCase
{
    public function testThatKernelBootsCorrectly()
    {
        ...
        $params = array(
            ...
            'metadata_enabled_entities' => array('array', array('Entity3', 'Entity4')),
            'table_prefix' => array('string', 'test_prefix'),
            'table_suffix' => array('string', 'test_suffix'),
            'meta_suffix' => array('string', 'test_meta_suffix'),
            ...
            'revision_meta_table_name' => array('string', 'test_meta_table_name'),
        ...
        $this->assertEquals($metadata->getMetadataEnabledClassNames(), $params['metadata_enabled_entities'][1]);
        ...
        $this->assertEquals($configuration->getMetaTableSuffix(), $params['meta_suffix'][1]);
        ...
        $this->assertEquals($configuration->getRevisionMetaTableName(), $params['revision_meta_table_name'][1]);
