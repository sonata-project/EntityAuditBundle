...
class RelationTest extends BaseTest
{
    ...
    public function testRelationsCached()
    {
        ...
        $this->assertEquals(array (
            ...
            2 => 'SELECT e.revtype, e.some_strange_key_name AS \'id\', e.crazy_title_to_mess_up_audit AS \'title\' FROM OwnerEntity_audit e  WHERE e.rev <= ? AND e.some_strange_key_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:3;i:1;i:1;}-a:0:{}',
            ...
            4 => 'SELECT e.revtype, e.strange_owned_id_name AS \'id\', e.even_strangier_column_name AS \'title\', e.owner_id_goes_here FROM OwnedEntity1_audit e  WHERE e.rev <= ? AND e.strange_owned_id_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:3;i:1;s:1:"1";}-a:0:{}',
            5 => 'SELECT e.revtype, e.some_strange_key_name AS \'id\', e.crazy_title_to_mess_up_audit AS \'title\' FROM OwnerEntity_audit e  WHERE e.rev <= ? AND e.some_strange_key_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:3;i:1;s:1:"1";}-a:0:{}',
            6 => 'SELECT e.revtype, e.some_strange_key_name AS \'id\', e.crazy_title_to_mess_up_audit AS \'title\' FROM OwnerEntity_audit e  WHERE e.rev <= ? AND e.some_strange_key_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:4;i:1;i:1;}-a:0:{}',
            ...
            8 => 'SELECT e.revtype, e.strange_owned_id_name AS \'id\', e.even_strangier_column_name AS \'title\', e.owner_id_goes_here FROM OwnedEntity1_audit e  WHERE e.rev <= ? AND e.strange_owned_id_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:4;i:1;s:1:"1";}-a:0:{}',
            9 => 'SELECT e.revtype, e.some_strange_key_name AS \'id\', e.crazy_title_to_mess_up_audit AS \'title\' FROM OwnerEntity_audit e  WHERE e.rev <= ? AND e.some_strange_key_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:4;i:1;s:1:"1";}-a:0:{}',
            10 => 'SELECT e.revtype, e.strange_owned_id_name AS \'id\', e.even_strangier_column_name AS \'title\', e.owner_id_goes_here FROM OwnedEntity1_audit e  WHERE e.rev <= ? AND e.strange_owned_id_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:4;i:1;s:1:"2";}-a:0:{}',
            11 => 'SELECT e.revtype, e.some_strange_key_name AS \'id\', e.crazy_title_to_mess_up_audit AS \'title\' FROM OwnerEntity_audit e  WHERE e.rev <= ? AND e.some_strange_key_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:5;i:1;i:1;}-a:0:{}',
            ...
            13 => 'SELECT e.revtype, e.strange_owned_id_name AS \'id\', e.even_strangier_column_name AS \'title\', e.owner_id_goes_here FROM OwnedEntity1_audit e  WHERE e.rev <= ? AND e.strange_owned_id_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:5;i:1;s:1:"1";}-a:0:{}',
            14 => 'SELECT e.revtype, e.some_strange_key_name AS \'id\', e.crazy_title_to_mess_up_audit AS \'title\' FROM OwnerEntity_audit e  WHERE e.rev <= ? AND e.some_strange_key_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:5;i:1;s:1:"1";}-a:0:{}',
            15 => 'SELECT e.revtype, e.strange_owned_id_name AS \'id\', e.even_strangier_column_name AS \'title\', e.owner_id_goes_here FROM OwnedEntity1_audit e  WHERE e.rev <= ? AND e.strange_owned_id_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:5;i:1;s:1:"2";}-a:0:{}',
            16 => 'SELECT e.revtype, e.some_strange_key_name AS \'id\', e.crazy_title_to_mess_up_audit AS \'title\' FROM OwnerEntity_audit e  WHERE e.rev <= ? AND e.some_strange_key_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:6;i:1;i:1;}-a:0:{}',
            ...
            18 => 'SELECT e.revtype, e.strange_owned_id_name AS \'id\', e.even_strangier_column_name AS \'title\', e.owner_id_goes_here FROM OwnedEntity1_audit e  WHERE e.rev <= ? AND e.strange_owned_id_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:6;i:1;s:1:"1";}-a:0:{}',
            19 => 'SELECT e.revtype, e.some_strange_key_name AS \'id\', e.crazy_title_to_mess_up_audit AS \'title\' FROM OwnerEntity_audit e  WHERE e.rev <= ? AND e.some_strange_key_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:6;i:1;s:1:"1";}-a:0:{}',
            20 => 'SELECT e.revtype, e.strange_owned_id_name AS \'id\', e.even_strangier_column_name AS \'title\', e.owner_id_goes_here FROM OwnedEntity1_audit e  WHERE e.rev <= ? AND e.strange_owned_id_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:6;i:1;s:1:"2";}-a:0:{}',
            21 => 'SELECT e.revtype, e.some_strange_key_name AS \'id\', e.crazy_title_to_mess_up_audit AS \'title\' FROM OwnerEntity_audit e  WHERE e.rev <= ? AND e.some_strange_key_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:7;i:1;i:1;}-a:0:{}',
            ...
            23 => 'SELECT e.revtype, e.strange_owned_id_name AS \'id\', e.even_strangier_column_name AS \'title\', e.owner_id_goes_here FROM OwnedEntity1_audit e  WHERE e.rev <= ? AND e.strange_owned_id_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:7;i:1;s:1:"2";}-a:0:{}',
            24 => 'SELECT e.revtype, e.some_strange_key_name AS \'id\', e.crazy_title_to_mess_up_audit AS \'title\' FROM OwnerEntity_audit e  WHERE e.rev <= ? AND e.some_strange_key_name = ? ORDER BY e.rev DESC LIMIT 1-a:2:{i:0;i:7;i:1;s:1:"1";}-a:0:{}',
            25 => 'SELECT rev, some_strange_key_name AS id, crazy_title_to_mess_up_audit AS title FROM OwnerEntity_audit e WHERE some_strange_key_name = ? ORDER BY e.rev DESC-a:1:{i:0;i:1;}-a:0:{}',
